...
const queryInsertWarehouseProduct = `INSERT INTO warehouse_products (id, warehouse_id, product_id, product_name, product_quantity, description, created_at, updated_at) VALUES ($1, $2, $3, $4, $5, $6, $7, $8);`
